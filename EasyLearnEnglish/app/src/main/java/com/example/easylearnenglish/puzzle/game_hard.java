...
public class game_hard extends AppCompatActivity implements card_Adapter.OnCardClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvTimer = findViewById(R.id.tvTimer2);
    ...
    private List<Integer> getRandomImageResIds(int i) {
        ...
        imageResIds.add(R.drawable.card_15);
        imageResIds.add(R.drawable.card_16);
        imageResIds.add(R.drawable.card_17);
        imageResIds.add(R.drawable.card_18);
        imageResIds.add(R.drawable.card_19);
        imageResIds.add(R.drawable.card_3);
        imageResIds.add(R.drawable.card_4);
        ...
        handler.post(new Runnable() {
            ...
            public void run() {
                ...
                if (seconds <= 0 && level == 1) {
                    ...
                    Toast.makeText(game_hard.this, "Time's up!", Toast.LENGTH_SHORT).show();
                    finish();
                    return;
                ...
                if (matchedPairs == cards.size() / 2) {
                    //Toast.makeText(game_hard.this, "You win!", Toast.LENGTH_SHORT).show();
                    handler.removeCallbacks(null);
                    level++;
                    if (level > maxLevel) {
                        Toast.makeText(game_hard.this, "Game Over!", Toast.LENGTH_SHORT).show();
                        finish();
                        return;
                    }
                    resetGame();
