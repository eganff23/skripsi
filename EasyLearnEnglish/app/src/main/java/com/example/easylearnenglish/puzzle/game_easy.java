...
public class game_easy extends AppCompatActivity implements card_Adapter.OnCardClickListener {
    ...
    private List<Integer> getRandomImageResIds(int count) {
        ...
        return imageResIds.subList(0, count);
    }
        ...
        handler.post(new Runnable() {
            ...
            public void run() {
                ...
                if (seconds <= 0 && level == 1) {
                    ...
                    Toast.makeText(game_easy.this, "Time's up!", Toast.LENGTH_SHORT).show();
                        finish();
                        return;
                ...
                if (matchedPairs == cards.size() / 2) {
                    //Toast.makeText(game_easy.this, "You win!", Toast.LENGTH_SHORT).show();
